...
$page_description = 'Forgot Password';
...
<form action="forgot_password.php" method="post">
    ...
    <div class="row">
        <p><label class="col-" for "name">Email Address:</label>
        <input class="input col-s-12 col-m-12 col-l-6" type="text" name="email" size="20" maxlength="40" value="<?php if (isset($_POST['email'])) echo $_POST['email']; ?>" /></p>
    </div>
    
    <div class="row">
        <p><input class="button button2" type="submit" name="submit" value="Reset My Password" /></p>
