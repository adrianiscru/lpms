...
$page_title = 'Terms And Conditions - ' . $niche . ' ';
$page_name = 'terms.php';

$page_description = 'These Website Standard Terms and Conditions written on this webpage shall manage your use of our ' . $activity . ' .';
    ...
    <div class="row"> <!-- PAGE CONTENT --> 
        <div class="col-s-12 col-m-12 col-l-12">
            <div class="boxed-container cms-editable text-left set-1-b shadow-box">
                ...
                <h2 class="mobile-small-text-1"><br>TERMS AND CONDITIONS</h2>
                <p>These Standard Terms and Conditions written on this webpage shall manage your use of our <?php echo ($activity);?> accessible from <u>https://localhost.0/OU/<?php echo strtolower ($niche);?></u>.
<br>
...
<p>Other than the content you own, under these Terms,  and/or its licensors own all the intellectual property rights and materials contained in this Website.<br>
...
<h3>Your Content</h3>  
<p>In these Website Standard Terms and Conditions, "Your Content" shall mean any audio, video text, images or other material you choose to display on this Website. By displaying Your Content, you grant  a non-exclusive, worldwide irrevocable, sub licensable license to use, reproduce, adapt, publish, translate and distribute it in any and all media.<br>
Your Content must be your own and must not be invading any third-party’s rights.  reserves the right to remove any of Your Content from this Website at any time without notice.
</p>
...
<p>These Terms will be governed by and interpreted in accordance with the laws of United Kingdom, and you submit to the non-exclusive jurisdiction of the state and federal courts located there for the resolution of any disputes.</p>
